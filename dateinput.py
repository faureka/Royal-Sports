...
class DateEntry(tk.Frame):
    def __init__(self, master, frame_look={}, **look):
        ...
        self.entry_3 = tk.Entry(self, width=8, **args)
    ...
    def get(self):
        return str(str(self.entry_1.get())+'-'+str(self.entry_2.get())+'-'+str(self.entry_3.get()))
...
if __name__ == '__main__':
    ...
    dentry = DateEntry(win, font=('Helvetica', 12, tk.NORMAL), border=0)
    dentry.pack()
